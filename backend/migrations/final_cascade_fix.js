...
// Corrected list of foreign keys to update with ON DELETE CASCADE
const foreignKeys = [
  {
    table: 'module_chapters',
    constraint: 'fk_chapters_workstream_cascade',
    legacyConstraints: ['module_chapters_ibfk_1', 'fk_module_chapters_workstream', 'fk_chapters_workstream'],
  ...
  {
    table: 'assessments',
    constraint: 'fk_assessments_chapter_cascade',
  ...
  },
  {
    ...
    constraint: 'fk_questions_assessment_cascade',
    legacyConstraints: ['assessment_questions_ibfk_1', 'fk_assessment_questions_assessment', 'fk_questions_assessment'],
  ...
  },
  {
    ...
    constraint: 'fk_choices_question_cascade',
    legacyConstraints: ['question_choices_ibfk_1', 'fk_question_choices_question', 'fk_choices_question'],
    column: 'question_id',
  ...
  {
    table: 'user_progress',
    constraint: 'fk_progress_chapter_cascade',
    legacyConstraints: ['user_progress_ibfk_1', 'fk_user_progress_chapter', 'fk_progress_chapter'],
    column: 'chapter_id',
    refTable: 'module_chapters',
    refColumn: 'chapter_id'
  },
  {
    ...
    constraint: 'fk_scores_assessment_cascade',
    legacyConstraints: ['user_assessment_scores_ibfk_1', 'fk_user_assessment_scores_assessment', 'fk_scores_assessment'],
    column: 'assessment_id',
    refTable: 'assessments',
    refColumn: 'assessment_id'
  },
  {
    ...
    constraint: 'fk_answers_assessment_cascade',
    legacyConstraints: ['assessment_answers_ibfk_1', 'fk_assessment_answers_assessment', 'fk_answers_assessment'],
    column: 'assessment_id',
    refTable: 'assessments',
    refColumn: 'assessment_id'
  }
